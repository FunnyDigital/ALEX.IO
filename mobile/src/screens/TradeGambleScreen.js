    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>
          Predict market movements and multiply your winnings!
        </Text>
        
        <Text style={styles.description}>
          This exciting trading game will allow you to bet on cryptocurrency 
          price movements and earn big rewards based on market trends.
        </Text>
